...
type Config struct {
	...
	// BaseURL overrides the API root (e.g. an Azure/gateway endpoint).
	// Defaults to DefaultBaseURL. The chat path is appended to it.
	BaseURL string `json:"base_url"`

	// Organization and Project set the optional OpenAI-Organization and
...
// Client is a concurrency-safe OpenAI Chat Completions client.
type Client struct {
	apiKey     string
	baseURL    string
	org        string
